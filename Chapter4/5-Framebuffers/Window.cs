...
namespace LearnOpenTK
{
    ...
    public class Window : GameWindow
    {
        ...
        private int rbo; // render buffer object
        ...
        protected override void OnLoad()
        {
            ...
            _shader = new Shader("Shaders/framebuffers.vert", "Shaders/framebuffers.frag");
            _screenShader = new Shader("Shaders/framebuffers_screen.vert", "Shaders/framebuffers_screen.frag");
            ...
            GL.RenderbufferStorage(RenderbufferTarget.Renderbuffer, RenderbufferStorage.Depth24Stencil8, 800, 600); // use a single rbo for both stencil and depth
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            GL.BindFramebuffer(FramebufferTarget.Framebuffer, 0);
            GL.Disable(EnableCap.DepthTest); // disable depth test fo screen-space quad isnt discarded due to depth test
