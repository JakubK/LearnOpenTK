...
namespace LearnOpenTK
{
    ...
    public class Window : GameWindow
    {
        ...
        private List<Vector3> windows = new()
        {
            new(-1.5f, 0.0f, -0.48f),
            new(1.5f, 0.0f, 0.51f),
            new(0.0f, 0.0f, 0.7f),
    ...
    public Window(GameWindowSettings gameWindowSettings, NativeWindowSettings nativeWindowSettings)
        ...
        protected override void OnLoad()
        {
            ...
            transparentTexture = Texture.LoadFromFile("Resources/window.png", TextureWrapMode.ClampToEdge);
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            var sortedWindows = new SortedDictionary<float, Vector3>();
            foreach (var t in windows)
            {
                var distance = Vector3.Distance(_camera.Position, t);
                sortedWindows[distance] = t;
            }
            ...
            foreach (var t in sortedWindows.Reverse())
            {
                model = Matrix4.Identity;
                model = Matrix4.CreateTranslation(t.Value) * model;
                _modelShader.SetMatrix4("model", model);
                GL.DrawArrays(PrimitiveType.Triangles, 0, 6);
            }
