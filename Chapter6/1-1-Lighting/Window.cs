...
namespace LearnOpenTK
{
    public class Window : GameWindow
    {
        ...
        protected override void OnLoad()
        {
            ...
            shader.Use();
            shader.SetVector3("albedo", new(0.5f, 0.0f, 0.0f));
            shader.SetFloat("ao", 1.0f);
            shader.SetMatrix4("projection", _camera.GetProjectionMatrix());
            
            LightPositions.Add(new(-10.0f,  10.0f, 10.0f));
            LightPositions.Add(new(10.0f,  10.0f, 10.0f));
            LightPositions.Add(new(-10.0f,  -10.0f, 10.0f));
            LightPositions.Add(new(10.0f,  -10.0f, 10.0f));
            
            LightColors.Add(new(300.0f, 300.0f, 300.0f));
            LightColors.Add(new(300.0f, 300.0f, 300.0f));
            LightColors.Add(new(300.0f, 300.0f, 300.0f));
            LightColors.Add(new(300.0f, 300.0f, 300.0f));
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            for (int row = 0; row < nrRows; ++row)
            {
                ...
                for (int col = 0; col < nrColumns; ++col)
                {
                    ...
                    // on direct lighting.
                    shader.SetFloat("roughness",  MathHelper.Clamp((float)col / nrColumns, 0.05f, 1.0f));
